...
State_RLBase::State_RLBase(int state_mode, std::string state_string) : FSMState(state_mode, state_string) {
...
void State_RLBase::run() {
    if (!env) {
        spdlog::warn("State_RLBase::run: Environment is null. Skipping run.");
        return;
    }
